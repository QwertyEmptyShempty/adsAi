...
export const accounts: AccountConfig[] = [
  { accountId: '1785894395737168', label: 'ADAP 6', active: false, destinationUrl: '', preferredPixelId: null, preferredPageId: null, dailyBudgetMinorUnits: 6000, notes: 'Disabled by Facebook (error_subcode 1885316) - confirmed 17.08' },
  ...
  { accountId: '1552629889693455', label: 'Стрылец 14 (L3)', active: false, destinationUrl: 'https://edgmete.top/l/7VVn65Eo/?b=6735&pixel=__PIXEL_ID__&campaign_id={{campaign.id}}&adset_id={{adset.id}}&ad_id={{ad.id}}&campaign_name={{campaign.name}}&adset_name={{adset.name}}&ad_name={{ad.name}}&placement={{placement}}&site_source_name={{site_source_name}}', preferredPixelId: null, preferredPageId: FINANS_DUNYASI_PAGE_ID, dailyBudgetMinorUnits: 6000 },
  { accountId: '1570672514652984', label: 'ADAP 5', active: false, destinationUrl: 'https://edgmete.top/l/7VVn65Eo/?b=6735&pixel=__PIXEL_ID__&campaign_id={{campaign.id}}&adset_id={{adset.id}}&ad_id={{ad.id}}&campaign_name={{campaign.name}}&adset_name={{adset.name}}&ad_name={{ad.name}}&placement={{placement}}&site_source_name={{site_source_name}}', preferredPixelId: null, preferredPageId: FINANS_DUNYASI_PAGE_ID, dailyBudgetMinorUnits: 6000 },
  ...
  { accountId: '1825618255067356', label: '01473 Luna-02', active: false, destinationUrl: 'https://edgmete.top/l/7VVn65Eo/?b=6735&pixel=__PIXEL_ID__&campaign_id={{campaign.id}}&adset_id={{adset.id}}&ad_id={{ad.id}}&campaign_name={{campaign.name}}&adset_name={{adset.name}}&ad_name={{ad.name}}&placement={{placement}}&site_source_name={{site_source_name}}', preferredPixelId: null, preferredPageId: FINANS_DUNYASI_PAGE_ID, dailyBudgetMinorUnits: 6000 },
  ...
  { accountId: '1058198873572693', label: '01473 Luna-10', active: false, destinationUrl: '', preferredPixelId: null, preferredPageId: null, dailyBudgetMinorUnits: 6000, notes: 'Disabled by Facebook (error_subcode 1885316) - confirmed 17.08' },
  { accountId: '2287041015373080', label: '01473 Luna-13', active: false, destinationUrl: 'https://edgmete.top/l/7VVn65Eo/?b=6735&pixel=__PIXEL_ID__&campaign_id={{campaign.id}}&adset_id={{adset.id}}&ad_id={{ad.id}}&campaign_name={{campaign.name}}&adset_name={{adset.name}}&ad_name={{ad.name}}&placement={{placement}}&site_source_name={{site_source_name}}', preferredPixelId: null, preferredPageId: FINANS_DUNYASI_PAGE_ID, dailyBudgetMinorUnits: 6000 },
  { accountId: '1232260615707619', label: '01473 Luna-16', active: true, destinationUrl: 'https://edgmete.top/l/7VVn65Eo/?b=6735&pixel=__PIXEL_ID__&campaign_id={{campaign.id}}&adset_id={{adset.id}}&ad_id={{ad.id}}&campaign_name={{campaign.name}}&adset_name={{adset.name}}&ad_name={{ad.name}}&placement={{placement}}&site_source_name={{site_source_name}}', preferredPixelId: '1062674762977615', preferredPageId: FINANS_DUNYASI_PAGE_ID, dailyBudgetMinorUnits: 6000, notes: 'Added 17.08, replacing blocked account' },
  { accountId: '1584452440133396', label: '01473 Luna-15', active: true, destinationUrl: 'https://edgmete.top/l/7VVn65Eo/?b=6735&pixel=__PIXEL_ID__&campaign_id={{campaign.id}}&adset_id={{adset.id}}&ad_id={{ad.id}}&campaign_name={{campaign.name}}&adset_name={{adset.name}}&ad_name={{ad.name}}&placement={{placement}}&site_source_name={{site_source_name}}', preferredPixelId: '1062674762977615', preferredPageId: FINANS_DUNYASI_PAGE_ID, dailyBudgetMinorUnits: 6000, notes: 'Added 17.08, replacing blocked account' },
  { accountId: '1765035847822404', label: 'Moon_T218', active: true, destinationUrl: 'https://edgmete.top/l/7VVn65Eo/?b=6735&pixel=__PIXEL_ID__&campaign_id={{campaign.id}}&adset_id={{adset.id}}&ad_id={{ad.id}}&campaign_name={{campaign.name}}&adset_name={{adset.name}}&ad_name={{ad.name}}&placement={{placement}}&site_source_name={{site_source_name}}', preferredPixelId: '1062674762977615', preferredPageId: FINANS_DUNYASI_PAGE_ID, dailyBudgetMinorUnits: 6000, notes: 'Added 17.08, replacing blocked account' },
  { accountId: '1558523475246746', label: 'Moon_T218 (2)', active: true, destinationUrl: 'https://edgmete.top/l/7VVn65Eo/?b=6735&pixel=__PIXEL_ID__&campaign_id={{campaign.id}}&adset_id={{adset.id}}&ad_id={{ad.id}}&campaign_name={{campaign.name}}&adset_name={{adset.name}}&ad_name={{ad.name}}&placement={{placement}}&site_source_name={{site_source_name}}', preferredPixelId: '1062674762977615', preferredPageId: FINANS_DUNYASI_PAGE_ID, dailyBudgetMinorUnits: 6000, notes: 'Added 17.08, replacing blocked account' },
  { accountId: '2318033695685299', label: 'ADAP 7', active: true, destinationUrl: 'https://edgmete.top/l/7VVn65Eo/?b=6735&pixel=__PIXEL_ID__&campaign_id={{campaign.id}}&adset_id={{adset.id}}&ad_id={{ad.id}}&campaign_name={{campaign.name}}&adset_name={{adset.name}}&ad_name={{ad.name}}&placement={{placement}}&site_source_name={{site_source_name}}', preferredPixelId: '1062674762977615', preferredPageId: FINANS_DUNYASI_PAGE_ID, dailyBudgetMinorUnits: 6000, notes: 'Added 18.08' },
  { accountId: '2104039074327697', label: 'ADAP 8', active: true, destinationUrl: 'https://edgmete.top/l/7VVn65Eo/?b=6735&pixel=__PIXEL_ID__&campaign_id={{campaign.id}}&adset_id={{adset.id}}&ad_id={{ad.id}}&campaign_name={{campaign.name}}&adset_name={{adset.name}}&ad_name={{ad.name}}&placement={{placement}}&site_source_name={{site_source_name}}', preferredPixelId: '1062674762977615', preferredPageId: FINANS_DUNYASI_PAGE_ID, dailyBudgetMinorUnits: 6000, notes: 'Added 18.08' },
  { accountId: '2188113005254777', label: 'Стрылец 17 (L3)', active: true, destinationUrl: 'https://edgmete.top/l/7VVn65Eo/?b=6735&pixel=__PIXEL_ID__&campaign_id={{campaign.id}}&adset_id={{adset.id}}&ad_id={{ad.id}}&campaign_name={{campaign.name}}&adset_name={{adset.name}}&ad_name={{ad.name}}&placement={{placement}}&site_source_name={{site_source_name}}', preferredPixelId: '1062674762977615', preferredPageId: FINANS_DUNYASI_PAGE_ID, dailyBudgetMinorUnits: 6000, notes: 'Added 18.08' },
];
